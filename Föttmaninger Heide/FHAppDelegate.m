...
- (void) addToCoreData {
    ...
    newArticle.title = @"Eichelhäher";
    newArticle.desc = @"Hier ein Nest gefunden";
    newArticle.latitude = [NSNumber numberWithInt:12345];
    newArticle.longitude = [NSNumber numberWithInt:12345];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CoreDataTest0.sqlite"];
